...
@section('content')
    <div class="col-md w-lg w-auto-sm light lt b-l">
        ...
        <div class="list-group no-radius no-borders light lt">
            ...
            <a  href="{{route('profile',$following->id)}}"data-toggle="modal" data-target="#chat" data-dismiss="modal"  class="list-group-item p-x-md text-ellipsis">
                <img src="../{{$following->profile_picture}}" class="w-24 m-r-sm img-circle">
